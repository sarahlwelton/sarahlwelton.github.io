...
Examples are non-AsciiDoc files that contain reusable content, such as source code or programmatic output, that's often inserted into xref:code-blocks.adoc[code blocks].
