...
The following sections describe the document editing process using the Atom editor. You can write AsciiDoc in the plain text editor or integrated development environment (IDE) of your choice.
