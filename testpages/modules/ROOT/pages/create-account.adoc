...
NOTE: If you have an Activation ID, after you <<sign-up-free-trial,>>, you can xref:manage-billing.adoc#add-activation-id[Add your Activation ID] to your account.
...
- xref:import-data-documents.adoc[Import your own data] 
- xref:creating-an-app-service.adoc[Add App Services to your database] for use with xref:couchbase-lite:ROOT:index.adoc[Couchbase Lite] and mobile applications
