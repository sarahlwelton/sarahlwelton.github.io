...
NOTE: For a video walkthrough on how to get started with offline-first data syncing using App Services, see the xref:app-services-video-tutorial[App Services Video Tutorial] section.
...
. Go to *Connect*.
. Next to the *Public Connection* field, click *[ Create App User ]*.
...
[#app-services-video-tutorial]
== App Services Video Tutorial

This video provides a walkthrough of Capella App Services capabilities by migrating an existing Couchbase Mobile app to Capella.

video::ei2UYjxoqec[youtube, width=800, height=480, title=Offline first data sync using Capella App Services – Tutorial]
