...
Use an em dash (—) to set off an aside or comment in your text. Don't use parentheses. Don't use an en dash or hyphen.
...
Use hyphens (-) to join words together, such as compound adjectives. A compound adjective is two or more words that collectively modify a noun. 
