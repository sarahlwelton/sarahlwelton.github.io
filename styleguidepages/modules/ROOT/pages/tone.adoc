...
| Keep to accurate statements about the product and its capabilities. We can guide users towards the best way to use a product, but it needs to stay objective and accurate. You can make a statement about a best practice recommendation with "Couchbase recommends...", but don't make a generalization on behalf of the company.  
| 
    _Couchbase Server 7.1 is the best version of Couchbase Server. You shouldn't use any other version._ 

    _Couchbase believes that VSCode is the best text editor and IDE to use for all of your programming needs._
...
Give them what they need to be successful without overwhelming them. 